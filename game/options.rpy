...
define config.name = _("Руководство \n Абитуриента")
...
define config.version = "Версия 1.0"
...
define gui.about = _p("""
                      Пройдите новеллу и узнайте все подробности обучения в КИПФИН от первого лица!

                      Руководство Абитуриента - это проект Информационно-Технического Сообщества Колледжа информатики и программирования Финансового университета при Правительстве РФ, созданный с любовью командой крутейших разработчиков. Давайте познакомимся поближе!
                      
                      Руководитель ИТС - Слободенюк Никита Владимирович
                      Руководитель команды и художник - Соболенко Анна Романовна
                      Программисты - Филин Дмитрий Антонович, Дима 
                      Автор диалогов - Трудова Анастасия Павловна
                      Автор звуков - Калиничева Елизавета Владимировна
                      Помощь в проработке сюжета - Андреева Виктория Алексеевна
...
define config.main_menu_music = "music_0.mp3"
...
define config.save_directory = "Novell-1745516516"
