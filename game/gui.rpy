...
define gui.accent_color = '#fd99a4'

## Цвет, используемый в текстовой кнопке, когда она не выбрана и не наведена.
define gui.idle_color = '#b1e0a2'
...
define gui.text_font = "AvenirNextW1GLight.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "RuneScape-ENA.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "AvenirNextW1GLight.ttf"

## Размер нормального текста диалога.
define gui.text_size = 55

## Размер имён персонажей.
define gui.name_text_size = 85
...
define gui.main_menu_background = "gui/oblojka.png"
...
define gui.choice_button_text_hover_color = "#b1e0a2"
