...
define gg = Character('Абитуриент', color="#fdfdfd")
define roditel = Character('Родитель', color="#fdfdfd")
define security = Character('Охранник', color="#c9ffc7")
define sotrudnic_103 = Character('Сотрудник из 103', color="#c9ffc7")
